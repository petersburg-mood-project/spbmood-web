...
<font size="6"> *авторские права на изображения: изображения являются результатами исследований, таким образом, правообладатели изображений - коллектив авторов проекта
</font>
